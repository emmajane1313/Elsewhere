...
export const metadata: Metadata = {
  title: "Of Elsewhere — Emma-Jane MacKinnon-Lee",
  description:
    "Burned at the edge of a new world. Pressed into the skin. 23 characters of immigrant bone.",
  metadataBase: new URL("https://emmajanemackinnonlee-history.com/"),
  twitter: {
...
export default function RootLayout({
  ...
  return (
    <html className="selection:bg-rojo selection:text-black">
      <head>
        <script
