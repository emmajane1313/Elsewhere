  ...
  return (
    <>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 grid-rows-3 lg:grid-rows-1 w-full text-center text-black text-xl md:text-2xl lg:text-3xl font-serif">
        <div className="bg-white flex text-left text-[2.2vw] items-center p-8 font-one ">
        ...
        <div className="bg-rojo flex text-justify text-[2.2vw] items-center p-8 font-one ">
        ...
        <div className="bg-black flex text-right text-[2.2vw] items-center p-8 font-one text-white">
          Vere. A classic French Norman name, knightly, patrician. From the town
          of Ver in Normandy. Brought to England in 1066 by Aubrey de Vere,
          riding with William the Conqueror.
        </div>
      ...
      <div className="bg-rojo flex text-justify text-[2.2vw] items-center p-8 font-konB w-full h-fit">
      ...
      <div className="bg-white text-rojo flex text-justify text-[2.2vw] items-center p-8 font-konB w-full h-fit">
        A full colonial life claimed. To marry the daughter of a transported
        convict on the Cook Vessel, and on the other, the surviving child of the Layton Plague,
        under the Poor Law migration.
      </div>
    </>
  );
};
